...
File Safety Rules:
- Only add "use client" at the top of files that use browser APIs (e.g., localStorage, window) or React hooks (useState, useEffect, etc.). Do not include it in purely static or server-rendered components.
